			...
			en: {
				translation: {
					...
					Cart: {
						Title: "Checkout",
						Snackbar: {
							ManualOrderPlaced: "Your order has been placed. A waiter will collect payment from you shortly.",
							DigitalOrderPlaced: "Your order has been placed and paid. We'll bring it as soon as possible!",
			...
			es: {
				translation: {
					...
					Cart: {
						Title: "Checkout",
						Snackbar: {
							ManualOrderPlaced: "Tu orden ha sido enviada. Un mesero irá a tu mesa a cobrar el pedido en breve.",
							DigitalOrderPlaced: "Tu orden ha sido pagada y enviada. Te la llevaremos lo antes posible!",
