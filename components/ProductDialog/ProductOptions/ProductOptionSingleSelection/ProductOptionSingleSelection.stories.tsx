...
import ProductOptionSingleSelection from "./ProductOptionSingleSelection";
...
const Template: ComponentStory<typeof ProductOptionSingleSelection> = (args) => <ProductOptionSingleSelection {...args} />;
