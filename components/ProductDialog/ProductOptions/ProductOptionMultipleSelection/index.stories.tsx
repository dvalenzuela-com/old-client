...
const Template: ComponentStory<typeof ProductOptionMultipleSelection> = (args) => (
  <ProductOptionMultipleSelection {...args} />
);
...
Min2Max3.args = {
  productOption: {
    ...option,
    default_values: [option.possible_values[0].id, option.possible_values[1].id],
    min_selection: 2,
    max_selection: 3,
  },
};
...
PreselectedValues.args = {
  ...
  selectedValues: {
    option_id: option.id,
    selected_values: [option.possible_values[2].id, option.possible_values[4].id],
  },
};
