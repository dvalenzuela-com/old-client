...
export const useCreateManualPaymentOrder = () => {
  return useHttpsCallable<ABCreateOrderData, ABCreateOrderResponse>(
    functions,
...
export const useCreateStripePaymentOrder = () => {
  return useHttpsCallable<ABCreateStripePaymentOrderData, ABCreateStripePaymentOrderResponse>(
    functions,
...
export const useCreateStripePaymentIntent = () => {
  return useHttpsCallable<ABCreateStripePaymentIntentData, ABCreateStripePaymentIntentResponse>(
    functions,
